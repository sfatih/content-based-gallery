...
export default class searchScreen extends Component {
  ...
  //     images: [{
  //             file_name: "masa",
  //             img_url: "https://firebasestorage.googleapis.com/v0/b/elliptical-disk-161320.appspot.com/o/assets%2FIMG_20180108_115012.jpg?alt=media&token=8358c7f5-4163-414e-8a14-2d29137a5898",
  //             tag: ["laptop", "technology", "electronic device", "computer hardware", "computer accessory", "electronics", "multimedia", "computer", "space bar", "netbook"]
  //         },
  //         {
  //             file_name: "sandalye",
  //             img_url: "https://firebasestorage.googleapis.com/v0/b/elliptical-disk-161320.appspot.com/o/assets%2FIMG_20180108_010649.jpg?alt=media&token=e69ce558-ad0a-45b8-9d07-d0a96e14189e",
  //             tag: ["ev", "araba"]
  //         },
  ...
  search(text) {
    ...
    if (!text) {
      this.setState({
        images: this.state.imagesReference,
      });
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        />{' '}
        <View style={styles.photoWrapper}> {images} </View>{' '}
      </View>
    );
  }
